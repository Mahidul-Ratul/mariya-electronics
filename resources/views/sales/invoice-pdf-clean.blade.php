    ...
    <div class="invoice-container">
        ...
        <div class="watermark">
            @if(file_exists(public_path('images/me_logo2.png')))
                <img src="{{ asset('images/me_logo2.png') }}" alt="Watermark" style="width: 200px; height: auto; opacity: 0.08;">
            @else
        ...
        <div class="header-section">
            <div class="header-logo">
                @if(file_exists(public_path('images/me_logo2.png')))
                    <img src="{{ asset('images/me_logo2.png') }}" alt="Mariya Electronics Logo" style="height: 80px; width: auto;">
                @else
