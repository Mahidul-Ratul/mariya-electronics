    ...
    <div class="row justify-content-center">
        <div class="col-lg-11">
            <div class="card shadow border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('sales.store-installment') }}" method="POST" id="installmentSaleForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- Customer's Wife Information -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <h5 class="border-bottom pb-2 mb-3 text-primary">
                                    <i class="fas fa-user-friends me-2"></i>Customer's Wife Information (Optional)
                                </h5>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="customer_wife_name" class="form-label">Wife's Name</label>
                                    <input type="text" class="form-control" id="customer_wife_name" name="customer_wife_name" value="{{ old('customer_wife_name') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="customer_wife_nid" class="form-label">Wife's NID Number</label>
                                    <input type="text" class="form-control" id="customer_wife_nid" name="customer_wife_nid" value="{{ old('customer_wife_nid') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="customer_wife_nid_image" class="form-label">Wife's NID Image</label>
...
function loadProducts() {
    ...
    fetch(`/api/products/by-brand-model?brand_id=${brandId}&model=${model}`)
        .then(response => response.json())
        .then(products => {
